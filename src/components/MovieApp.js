...
const legends = {
  ...
  year: 2019,
  image:
    "https://static1.purebreak.com/articles/4/17/61/34/@/674062-legends-of-tomorrow-saison-4-un-person-diapo-1.jpg",
  rating: 4
};
const supernatural = {
  title: "Supernatural",
...
const naruto = {
  ...
  year: 2006,
  image:
    "https://media.senscritique.com/media/000010686578/source_big/Naruto_Shippuden.jpg",
  rating: 3
};
